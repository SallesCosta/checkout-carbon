...
import { ChevronDown } from '@/components/CustomIcon/Icon'
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      'border-input placeholder:text-muted-foreground relative z-10 flex h-9 w-full items-center justify-between whitespace-nowrap rounded-md border bg-transparent px-3 py-2 text-sm shadow-sm ring-offset-background focus:outline-none focus:ring-1 focus:ring-ring disabled:cursor-not-allowed disabled:opacity-50 [&>span]:line-clamp-1',
      className,
    )}
    {...props}
  >
  ...
  <SelectPrimitive.Item
    ...
    className={cn(
      'focus:bg-accent focus:text-accent-foreground relative flex w-full' +
        ' cursor-default select-none items-center rounded-sm py-0.5 pl-2 pr-8 text-sm outline-none data-[disabled]:pointer-events-none data-[disabled]:opacity-50',
      className,
    )}
    {...props}
  >
